...
const FinancialInfo = () => {
  ...
  return (
    <Grid container direction='column' alignItems='center' sx={{ width: '1000px', height: 800, border: '1px solid red', borderRadius: 3 }}>
        ...
        <form onSubmit={handleSubmit}>
                    ...
                    <FormControl sx={{ m: 1, width: 400 }}>
                        <InputLabel id="demo-simple-select-label">Main Source of Cooking</InputLabel>
                            <Select
                                ...
                                >
                                <MenuItem value="1">Butane</MenuItem>
                                <MenuItem value="2">Electric Current</MenuItem>
                                <MenuItem value="3">Wood</MenuItem>
                                <MenuItem value="4">Coal</MenuItem>
                                <MenuItem value="5">Charcoal</MenuItem>
                                <MenuItem value="5">Kerosene</MenuItem>
                            </Select>
                        </FormControl>
                </Grid>            
            </Grid>
            ...
            <Grid item>
                <Grid container direction='row' sx={{ paddingTop: 2 }}>
                    <div style={{ width: "23px" }} />
                    <FormControl sx={{ m: 1, width: 400 }}>
                        <InputLabel id="demo-simple-select-label">Internet Access</InputLabel>
                            <Select
                                name="durabilityOfHouse"
                                value={formValues.durabilityOfHouse}
                                onChange={handleInputChange}
                                ...
                                <MenuItem value="2">Mobile Data</MenuItem>
                                <MenuItem value="3">No Access</MenuItem>
                            </Select>
                        </FormControl>
        ...
        <Grid item sx={{ paddingTop: 5 }}>
            <Typography variant="h6" color="black" align='center' sx={{ fontFamily: 'Helvetica', paddingLeft: 4 }}>
