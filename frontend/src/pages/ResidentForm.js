...
import { Grid, TextField, Select, MenuItem, Button, Card} from "@mui/material";
...
const ResidentForm = () => {
  ...
  return (
    <Card className={classes.pageLayout} direction='column' alignItems='center'>
        <Grid container direction='column' alignItems='center' sx={{ display: { sx: "none", sm:"flex" }, width: '1000px', height: 900, border: '1px solid red', borderRadius: 3 }}>
        ...
        {/* For mobile */}
        <Grid container direction='column' alignItems='center' sx={{ display: { xs: 'none', sm: 'block', md: 'none' }, width: '300px', height: 900, border: '1px solid red', borderRadius: 3 }}>
            <Grid item sx={{ paddingTop: 5}}>
                <Typography variant="h4" color="black" align="center" sx={{ fontFamily: 'Helvetica', fontWeight: 200 }}>
                    For Residents
                </Typography>
